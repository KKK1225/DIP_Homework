...
### results show
first, run the following command to generate the results:
(We take chair as an example. You can also use other datasets, such as lego, to try.)
```
python mvs_with_colmap.py --data_dir data/chair
python debug_mvs_by_projecting_pts.py --data_dir data/chair
python train.py --colmap_dir data/chair --checkpoint_dir data/chair/checkpoints
...
<img src="result_chair/epoch_0195/r_86.png" alt="train 1" style="width: 80%;"/>
<img src="result_chair/epoch_0196/r_86.png" alt="train 2" style="width: 80%;"/>
<img src="result_chair/epoch_0197/r_86.png" alt="train 3" style="width: 80%;"/>
<img src="result_chair/epoch_0198/r_86.png" alt="train 4" style="width: 80%;"/>
<img src="result_chair/epoch_0199/r_86.png" alt="train 5" style="width: 80%;"/>